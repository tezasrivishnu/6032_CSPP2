...
class Solution {
    ...
    /**
     * method to execute double class.
     *
    ...
    /**
     * executing float class.
     *
     * @param      stdin  is the parameter.
     */
            ...
            switch (tokens[0]) {
                ...
                case "subList":
                    ...
                    List object = l.subList(
                        Integer.parseInt(arrstring3[0]), Integer.
                        parseInt(arrstring3[1]));
                    if (object != null) {
                        System.out.println(object);
                    }
